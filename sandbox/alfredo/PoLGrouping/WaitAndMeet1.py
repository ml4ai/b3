...
from XmlActivity import XmlActivity;  # @UnusedImport

class WaitAndMeet1(object):
    def __init__(self, actor):
        ...
        self.nLag_Time = 500; #Lag WaitAndMeet1 Time (in Num. of Frames)
        self.nTime = 0;
        self.aBeliefs = [];
...
#             self.nInitRange = nFrame;
            self.bActive = True;
            print nFrame, "WaitAndMeet1 Activated on subject:", self.actor.nTrackId;
